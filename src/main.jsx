...
function App() {
  ...
  if (page === 'auth') {
    return <AuthPage mode={authMode} setMode={setAuthMode} onBack={backToHome} onAuthSuccess={openFormPage} />;
  }
  ...
  if (page === 'dashboard') {
    return <DashboardPage formData={dashboardData || {}} setFormData={setDashboardData} onLogout={backToHome} />;
  }

  return (
    <main className="site-wrapper">
      <Navbar active={active} isOpen={isOpen} setIsOpen={setIsOpen} goTo={goTo} theme={theme} setTheme={setTheme} openLogin={openLogin} openRegister={openRegister} />
...
function Navbar({ active, isOpen, setIsOpen, goTo, theme, setTheme, openLogin, openRegister }) {
  return (
      ...
      <div className="container-fluid px-4 px-lg-5">
        <div className="row g-4 align-items-start">
          ...
          <div className="col-lg-2">
            ...
            <p className="footer-text mt-4 mb-0">© 2025 CAREVO. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
