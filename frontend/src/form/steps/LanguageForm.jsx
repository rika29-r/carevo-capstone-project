...
function SearchableLanguageSelect({ value, onChange }) {
  ...
  return (
    <div className="searchable-select" ref={wrapperRef}>
      <div
        className={`searchable-select-box ${isOpen ? "open" : ""} ${selectedFlag ? "" : "no-flag"
          }`}
      >
        {selectedFlag && (
      ...
      <div className="form-card language-card">
        <div className="card-header">
          <div>
            ...
            <p className="card-subtitle">
              Optional. You can skip this section if you do not want to add a language.
            </p>
          </div>
        </div>
        ...
        <div className="card-body">
          <div className="optional-info-box">
            ...
            <p>
              Bagian language tidak wajib diisi. Kamu tetap bisa klik Finish
          ...
          <div className="field-group">
            ...
            <div className="radio-grid">
              {proficiencyOptions.map((option) => (
                <label
                  key={option}
                  className={`radio-option ${languages.proficiency === option ? "active" : ""
                    }`}
                >
                  <input
                    type="radio"
